##################################################################################
# Analyses lat, climate, and mean trait data predicting Fruit Number
## Daniel Anstett
...
#1. Does geography predict success?
  ...
  plot1<-visreg(qu_lat, "Latitude", scale="response", partial=TRUE, gg=TRUE, line=list(col="black")) +
    geom_point(size=1)+ scale_y_continuous(name="Fruit Number")+ theme_classic()
...
#    geom_hline(yintercept=19003.09930)+
  ...
  plot1
ggsave("Single_fruit_fig/1.Lat.pdf", width = 7, height = 6, units = "in")
...
#2. Does distance to common garden predict Fruit_no_damage?
  ...
  plot2 <- plot2 + theme(axis.text.x = element_text(size=13, face="bold"),
                         ...
                         axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot2
  ggsave("Single_fruit_fig/2.Diatance.pdf", width = 7, height = 6, units = "in")
...
#3. What environmental variables at each location best predicts success?
  ...
  qu_MAT_RH <- glm.nb(Fruit_no_damage ~ MAT + MSP + RH + I(MAT^2), data=ksr_m)
  ...
  plot3A <-visreg(qu_MAT_RH, "MAT", scale="response", partial=TRUE, gg=TRUE, line=list(col="black")) +
    ...
    scale_y_continuous(name="Fruit Number")+ theme_classic()
  ...
  plot3A
  ggsave("Single_fruit_fig/3A.MAT.pdf", width = 7, height = 6, units = "in")
  ...
  plot3B
  ggsave("Single_fruit_fig/3B.RH.pdf", width = 7, height = 6, units = "in")
...
#4. What env distance (common garden env – genotype’s env) best predicts success?
  ...
  qu_MAT_MSP_D <- glm.nb(Fruit_no_damage ~ MSP_Distance + I(MAT_Distance^2)) 
  ...
  plot4 <-visreg(qu_MAT_D, "MAT_Distance", scale="response", partial=TRUE, gg=TRUE, line=list(col="black")) +
    ...
    scale_y_continuous(name="Fruit Number",limits=c(0,100000))+ theme_classic()
  ...
  ggsave("Single_fruit_fig/4.MAT_distance.pdf", width = 7, height = 6, units = "in")
...
#5. Does herb impact predict success?
  ...
  #a. Do leaf herbiovry and xylem feeders impact Fruit Number?
 ...
 #bug not having a negative effect no Fruit Number
  plot5a <- visreg(qu_bug, "bug", scale="response", partial=TRUE, gg=TRUE, line=list(col="black")) +
    ...
    scale_y_continuous(name="Fruit Number",limits=c(0,105000))+ theme_classic()
  plot5a <- plot5a + theme(axis.text.x = element_text(size=13, face="bold"),
                         ...
                         axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot5a
  ggsave("Single_fruit_fig/5A.bug.pdf", width = 7, height = 6, units = "in")
  
  #c. Does seed predation impact Fruit Number?
  ...
  plot5b <- plot5b + theme(axis.text.x = element_text(size=13, face="bold"),
                           ...
                           axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot5b
  ggsave("Single_fruit_fig/5B.sf.pdf", width = 7, height = 6, units = "in")
  ...
  plot5c <- plot5c + theme(axis.text.x = element_text(size=13, face="bold"),
                           ...
                           axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot5c
  ggsave("Single_fruit_fig/5C.mb.pdf", width = 7, height = 6, units = "in")
...
#Quantile regression
  ...
  plot_5q1 <- ggplot(ksr_m, aes(S.florida,Fruit_no_damage)) +
    ...
    scale_y_continuous(name="Fruit Number")+ pref_theme
  plot_5q1
  ggsave("Single_fruit_fig/Quan1.mb.pdf", width = 7, height = 6, units = "in")
...
#Graphs
  ...
  plot6a <- plot6a + theme(axis.text.x = element_text(size=13, face="bold"),
                             ...
                             axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot6a
#  ggsave("Single_fruit_fig/6a.Flowering.pdf", width = 7, height = 6, units = "in")
#Bolt Date
  ...
  plot6b <- plot6b + theme(axis.text.x = element_text(size=13, face="bold"),
                         ...
                         axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot6b
#  ggsave("Single_fruit_fig/6b.bolt.pdf", width = 7, height = 6, units = "in")
  ...
  plot_5q3 <- ggplot(ksr_m, aes(Bolt_Date,Fruit_no_damage)) +
    ...
    scale_y_continuous(name="Fruit Number")+ pref_theme
  plot_5q3
#  ggsave("Single_fruit_fig/Quan3.bd.pdf", width = 7, height = 6, units = "in")
...
#Growth Rate
  ...
  plot6c <- plot6c + theme(axis.text.x = element_text(size=13, face="bold"),
                         ...
                         axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot6c   
#  ggsave("Single_fruit_fig/6c.Growth_rate.pdf", width = 7, height = 6, units = "in")
...
#7. Does morphology predict success?
  ...
  plot7a <- plot7a + theme(axis.text.x = element_text(size=13, face="bold"),
                           ...
                           axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot7a
#  ggsave("Single_fruit_fig/7a.Tricomes.pdf", width = 7, height = 6, units = "in")
  ...
  plot7b <- plot7b + theme(axis.text.x = element_text(size=13, face="bold"),
                           ...
                           axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot7b
#  ggsave("Single_fruit_fig/7b.wc.pdf", width = 7, height = 6, units = "in")
  ...
  plot7c <- plot7c + theme(axis.text.x = element_text(size=13, face="bold"),
                           ...
                           axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot7c
#  ggsave("Single_fruit_fig/7c.SLA.pdf", width = 7, height = 6, units = "in")
...
################################
  ...
  plot8a<-visreg(qu_tphe_leaf, "Leaf_Totphe", scale="response", partial=TRUE, gg=TRUE, line=list(col="black")) +
    geom_point(size=1)+ scale_y_continuous(name="Fruit Number", limits=c(0,100000),
  ...
  plot8a <- plot8a +   theme(axis.text.x = element_text(size=13, face="bold"),
                             ...
                             axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot8a
  ggsave("Single_fruit_fig/8a_Leaf_totphe.pdf",width=7,height=6,units="in")
...
################################ 
  ...
  plot8b <- plot8b +   theme(axis.text.x = element_text(size=13, face="bold"),
                             ...
                             axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot8b
  ggsave("Single_fruit_fig/8b_Flower_totphe.pdf",width=7,height=6,units="in")
...
################################   
  ...
  plot8c <- plot8c +   theme(axis.text.x = element_text(size=13, face="bold"),
                             ...
                             axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
  plot8c
  ggsave("Single_fruit_fig/8c_Fruit_totphe.pdf",width=7,height=6,units="in")
...
#models Leaf
    ...
    plot9a <- plot9a +   theme(axis.text.x = element_text(size=13, face="bold"),
                               ...
                               axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
    plot9a
    ggsave("Single_fruit_fig/9a_Leaf_oe.pdf",width=7,height=6,units="in")
...
#models Flower
   ...
   plot(oe_Flower$Flower_Oenothein_B,oe_Flower$Fruit_no_damage) #First order only
    ...
    plot9b <- plot9b +   theme(axis.text.x = element_text(size=13, face="bold"),
                               ...
                               axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
    plot9b
    ggsave("Single_fruit_fig/9b_Flower_oe.pdf",width=7,height=6,units="in") #missing out outlier
...
#models Fruit
    ...
    plot9c <- plot9c +   theme(axis.text.x = element_text(size=13, face="bold"),
                               ...
                               axis.title.y = element_text(color="black", size=15,vjust = 2, face="bold",hjust=0.6))
    plot9c
    ggsave("Single_fruit_fig/9c_Fruit_oe.pdf",width=7,height=6,units="in") #missing out outlier
...
##################################################################################
# 10. What traits are most important in predicting Fruit Number
...
qu_all <- glm.nb(Fruit_no_damage ~ Flowering_Date + Bolt_Date + Growth_Rate + Num_Trichomes + 
